<div style="background: #222; padding: 30px 0 50px;">
	<div class="container">
		<div class="row">
			<div class="col-md-12">
				<h1 style="color: #fff;">Buttons</h1>
				<div>
					<a href="#" class="button-tiny-fill">button-tiny</a>
					<a href="#" class="button-small-fill">button-small</a>
					<a href="#" class="button-fill">button</a>
					<a href="#" class="button-large-fill">button-large</a>
				</div>
				<br>
				<br>
				<div>
				...
				<br>
				<div>
					<a href="#" class="button-tiny-clear">button-tiny</a>
					<a href="#" class="button-small-clear">button-small</a>
					<a href="#" class="button-clear">button</a>
					<a href="#" class="button-large-clear">button-large</a>
					<a href="#" class="button-large-fw-clear">button-large-fw</a>
				</div>
				<br>
				<br>
				<div>
